...
$("#canvas-draft").mousedown(function(e) {
  //Caprue the mouse location within the DOM window
  let mouseX = e.offsetX;
  let mouseY = e.offsetY;
  //Pass the coodirnates to the strategy pattern currently set
  currentFunction.onMouseDown([mouseX, mouseY], e);
  dragging = true;
});

$("#canvas-draft").mousemove(function(e) {
  //Capture the mouse location within the DOM window
  let mouseX = e.offsetX;
  let mouseY = e.offsetY;
  if (dragging) {
